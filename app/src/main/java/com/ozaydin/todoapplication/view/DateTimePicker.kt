package com.ozaydin.todoapplication.ui
...
import com.ozaydin.todoapplication.viewmodel.DateTimePickerViewModel
...
fun MainScreen() {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val task = ToDoModel(title.value.toString(), description.value.toString(),null,null,false)
